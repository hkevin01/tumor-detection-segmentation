...
class TestMedicalImagePreprocessor:
    ...
    def test_preprocess_standard_image(self, preprocessor: MedicalImagePreprocessor):
    ...
    def test_preprocess_image_modalities(
        ...
        try:
            result = preprocessor.preprocess_image(image, modality=modality)
    ...
    def test_large_image_processing(
        ...
        try:
            result = preprocessor.preprocess_image(large_image, modality="MRI")
